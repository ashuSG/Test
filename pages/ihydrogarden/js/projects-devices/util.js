function renderProjects(projects_list) {
    for (var i = 0; i < Object.keys(projects_list).length; i++) {
        var project_name = projects_list[i].pname; // or however you access project name
        var device_name = projects_list[i].device_name; // adjust this as necessary based on your data structure

        var projectsHtml = '<div class="col-sm-4" style="background-color:white;">' +
            ...
            `<button type="button" class="select" onclick="onClickSelectProject('${project_name}', '${device_name}')">Select</button>&nbsp;` +
...
function onClickSelectProject(project_name, device_name) {
    // Set the current project and device in localStorage
