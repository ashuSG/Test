...
$("#apply-chart-setting-btn").click(function() {
    ...
    } else if (checkedZoneNames.length == 0 && checkedIndSNames.length == 0 && checkedDirectSNames.length == 0) {
      // alert("Please select a data to be displayed");
    } else {
      $("#no-data-selected-msg").hide();
      // 08/25/2018 3:00 PM
      // 08/26/2018 12:45 AM
      queryChart(checkedZoneNames, checkedIndSNames, checkedDirectSNames, startDate, endDate);
      readChart();
...
//                 clearTimeout(timer);
//             } else {
//               document.location.href = "data-chart.html";
//             }
//           }
//         });
//       });
