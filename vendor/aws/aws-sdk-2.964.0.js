        ...
        AWS.util.update(AWS.S3.prototype, {
            ...
            populateUriFromAccessPointArn: function populateUriFromAccessPointArn(req) {
                ...
                if (isObjectLambdaArn) {
                    ...
                    endpoint.hostname = [ accesspointName + "-" + accessPointArn.accountId, serviceName, useArnRegion ? accessPointArn.region : req.service.config.region, dnsSuffix ].join(".");
                }
                endpoint.host = endpoint.hostname;
            ...
            willComputeChecksums: function willComputeChecksums(req) {
                ...
                var body = req.httpRequest.body;
                var needsContentMD5 = rules.ContentMD5 && !req.params.ContentMD5 && body && (AWS.util.Buffer.isBuffer(req.httpRequest.body) || typeof req.httpRequest.body === "string");
...
}, {}, [ 110 ]);AWS.apiLoader.services["s3"]["2006-03-01"] = {
    version: "2.0",
    metadata: {
