...
function FluidMeter() {
  ...
  function drawText() {
    ...
    context.fillText(text, options.size / 2, options.size / 2); // X, Y
    ...
    // context.textBaseline = 'middle';
    // context.filter = "drop-shadow(0px 0px 5px rgba(0,0,0,0.4))"
    // context.font = "14px Amazon Ember";
    // context.fillText("1200", 10, options.size / 2 + 100);
    // context.restore();
  }
  ...
  function getFontSize() {
    // console.log(options.fontSize + " " + options.fontFamily)
